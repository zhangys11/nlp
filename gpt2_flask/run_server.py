...
class ReusableForm(Form):
    ...
    # Starting seed
    seed = StringField("Enter a seed sentence:", validators=[
...
def load_gpt2_model():
    ...
    # Load Model File
    state_dict = torch.load('GPT2/gpt2-pytorch_model.bin', map_location='cpu' if not torch.cuda.is_available() else None)
